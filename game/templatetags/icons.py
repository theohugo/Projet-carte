...
ICONS = {
    ...
    "metamorph": '<path d="M7 6.2c1.2-1.5 3-2.4 5-2.4 3.8 0 6.8 3 6.8 6.8 0 5.2-4.1 9.6-9.3 9.6-3.2 0-5.3-1.8-5.3-4.5 0-2.2 1.6-3.9 3.8-3.9 1.7 0 2.8 1 4 2.1"/>'
    '<path d="M8.8 8.8h.01M15.2 8.8h.01"/>',
    "rocket": '<path d="M6 20V4h6.1a4.2 4.2 0 0 1 0 8.4H6"/><path d="m11.2 12.4 6.8 7.6"/>',
    "islands": '<path d="M3.5 15.2c2.8-2 5.7-2 8.5 0s5.7 2 8.5 0"/><path d="M3.5 19c2.8-2 5.7-2 8.5 0s5.7 2 8.5 0"/><path d="m8 12 4-8 4 8"/>',
    "race": '<path d="M5.2 16.7A7.6 7.6 0 1 1 18.8 17"/><path d="m12 12 4.7-3.2"/><path d="M4.2 20h15.6"/>',
    # Social
